...
{
    public class EventJsonConverters : JsonConverter<BaseEvent>
    {
        ...
        public override BaseEvent? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            var typeDiscrimintaor = type.GetString();
            var json = doc.RootElement.GetRawText();

            return typeDiscrimintaor switch
            {
                ...
                _ => throw new JsonException($"{typeDiscrimintaor} is not supported yet!")
            };
        }
